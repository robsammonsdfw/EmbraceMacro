...
export const MEDICAL_INTAKE_QUESTIONS: IntakeQuestion[] = [
    ...
    // Refined for Telehealth: Removed Home Address & Emergency Contact. Added Zip/State for jurisdiction.
    ...
    { id: 'gen_phone', text: 'Mobile Phone Number', type: 'text', section: SECTIONS.GENERAL },
    { id: 'gen_zip', text: 'Zip Code (US Only)', type: 'number', section: SECTIONS.GENERAL },
    { id: 'gen_state', text: 'State of Residence', type: 'choice', section: SECTIONS.GENERAL, options: ['AL','AK','AZ','AR','CA','CO','CT','DE','FL','GA','HI','ID','IL','IN','IA','KS','KY','LA','ME','MD','MA','MI','MN','MS','MO','MT','NE','NV','NH','NJ','NM','NY','NC','ND','OH','OK','OR','PA','RI','SC','SD','TN','TX','UT','VT','VA','WA','WV','WI','WY'] },
    { id: 'gen_gender', text: 'Biological Sex', type: 'choice', options: ['Male', 'Female'], section: SECTIONS.GENERAL },
    ...
    { id: 'gen_occupation', text: 'Occupation (Optional)', type: 'text', section: SECTIONS.GENERAL },
    
    // --- 2. PHARMACY & GOALS (Page 2) ---
    { id: 'pharm_name', text: 'Preferred Pharmacy Name', type: 'text', section: SECTIONS.PHARMACY },
    { id: 'pharm_phone', text: 'Preferred Pharmacy Phone', type: 'text', section: SECTIONS.PHARMACY },
    { id: 'goal_expectations', text: 'What are your health goals for this visit?', type: 'text', section: SECTIONS.PHARMACY },
    { id: 'health_last_well', text: 'When was the last time you felt truly well?', type: 'text', section: SECTIONS.PHARMACY },
    { id: 'allergies', text: 'List ALL Allergies (Medication/Food/Environment) & Reactions:', type: 'text', section: SECTIONS.PHARMACY },
    ...
    { id: 'hist_neuro', text: 'Neurologic/Mood', type: 'multiselect', section: SECTIONS.HISTORY, options: ['Depression', 'Anxiety', 'Bipolar', 'Schizophrenia', 'Headaches', 'Migraines', 'ADD/ADHD', 'Seizures', 'None'] },
    { id: 'hist_surgery', text: 'List any major surgeries and years performed:', type: 'text', section: SECTIONS.HISTORY },
    { id: 'hist_hospital', text: 'List any recent hospitalizations (Date & Reason):', type: 'text', section: SECTIONS.HISTORY },

    // --- 4. WOMEN'S HEALTH (Page 5) ---
    { id: 'fem_menses_freq', text: 'Menses Frequency', type: 'text', section: SECTIONS.WOMENS },
    { id: 'fem_contraception', text: 'Current Contraception?', type: 'multiselect', options: ['None', 'Condom', 'Pill', 'IUD', 'Patch', 'Ring', 'Partner Vasectomy', 'Tubal Ligation'], section: SECTIONS.WOMENS },
    { id: 'fem_conditions', text: 'Gynecologic History', type: 'multiselect', options: ['Fibrocystic Breasts', 'Endometriosis', 'Fibroids', 'Infertility', 'PMS', 'Heavy Periods', 'None'], section: SECTIONS.WOMENS },
    { id: 'fem_menopause', text: 'Are you in menopause?', type: 'choice', options: ['Yes', 'No', 'Peri-menopause'], section: SECTIONS.WOMENS },
    { id: 'fem_preg', text: 'Are you currently pregnant or breastfeeding?', type: 'choice', options: ['Yes', 'No'], section: SECTIONS.WOMENS },

    // --- 5. MEN'S HEALTH (Page 5) ---
    { id: 'male_psa', text: 'Have you had a PSA test in the last year?', type: 'choice', options: ['Yes', 'No'], section: SECTIONS.MENS },
    ...
    { id: 'meds_list', text: 'List ALL current medications (Name, Dosage, Frequency):', type: 'text', section: SECTIONS.MEDS },
    { id: 'supps_list', text: 'List current supplements/vitamins:', type: 'text', section: SECTIONS.MEDS },
    { id: 'meds_antibiotics', text: 'History of antibiotic use?', type: 'choice', options: ['Rare (<5 times lifetime)', 'Moderate (>5 times)', 'Frequent'], section: SECTIONS.MEDS },

    // --- 7. FAMILY HISTORY (Page 7) ---
    // Condensed to text blocks for easier digital entry vs the grid
    ...
    { id: 'life_diet', text: 'Do you follow a specific diet?', type: 'multiselect', options: ['None', 'Vegan', 'Vegetarian', 'Keto', 'Gluten-Free', 'Dairy-Free', 'Low Sodium', 'Low Carb'], section: SECTIONS.LIFESTYLE },
    ...
    { id: 'life_stress', text: 'Rate your typical stress (1-10)', type: 'number', section: SECTIONS.LIFESTYLE },
    { id: 'life_sleep', text: 'Average hours of sleep per night?', type: 'number', section: SECTIONS.LIFESTYLE },

    // --- 9. ENVIRONMENT (Page 11) ---
    { id: 'env_sensitivities', text: 'Do you have known food sensitivities?', type: 'choice', options: ['Yes', 'No'], section: SECTIONS.ENVIRONMENT },
    { id: 'env_exposures', text: 'Known exposure to toxins (Mold, Chemicals)?', type: 'multiselect', options: ['Mold', 'Chemicals', 'Herbicides', 'Pesticides', 'Heavy Metals', 'None'], section: SECTIONS.ENVIRONMENT },

    // --- 10. MSQ (Page 12) --- 
    // Medical Symptom Questionnaire - Essential for functional medicine analysis
    ...
    { id: 'msq_mind', text: 'Mind (Poor memory, Confusion, Concentration)', type: 'scale', subtext: '0=Never, 4=Severe', section: SECTIONS.MSQ },
    ...
    { id: 'sym_eating', text: 'Eating Habits', type: 'multiselect', options: ['Binge Eating', 'Bulimia', 'Can\'t Gain Weight', 'Can\'t Lose Weight', 'Poor Appetite', 'Salt Cravings', 'Carb Cravings', 'None'], section: SECTIONS.SYMPTOMS },
